...
class TodoitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todoitem" do
    assert_difference("Todoitem.count") do
      post todoitems_url, params: { todoitem: { completed: @todoitem.completed, content: @todoitem.content } }
    end
  ...
  test "should update todoitem" do
    patch todoitem_url(@todoitem), params: { todoitem: { completed: @todoitem.completed, content: @todoitem.content } }
