class TodoitemsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to todoitems_path, status: :see_other, notice: "Todoitem was successfully destroyed." }
  ...
  private
    ...
    def set_todoitem
      @todoitem = Todoitem.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def todoitem_params
      params.expect(todoitem: [ :content, :completed ])
    end
end
